...
class ZEditableModalColumnRav extends ZKDataColumn
{
    ...
    {            
        ...
        $this->widgetOptions = ZArrayHelper::merge($this->widgetOptions, [
            'id' => $id,
            'config' => [
                'dependAttr' => '-' . $key,
            ]
        ...
        return ZKEditableWidgetNorm::widget([
            'readonly' => $readonly,
            'model' => $model,
    ...
    public static function run($configs, $column, $attribute)
    {
        ...
        return function ($model, $key, $index) use ($configs, $column, $attribute) {
            ...
            return [
                ...
                //'width' => '200px',
                'id' => $modelBase . '-' . $attribute . '-' . $index . '-' . $key,
