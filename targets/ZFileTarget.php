 ...
 * @since 2.0
 */
class ZFileTarget extends ZTarget
{
	/**
	...
	public function init()
	{
		...
		if ($this->logFile === null) {
			$this->logFile = Az::$app->getRuntimePath() . '/logs/app.log';
		} else {
			$this->logFile = Az::getAlias($this->logFile);
		}
	...
	public function export()
	{
		...
		if ($this->enableRotation) {
			...
			// this may result in rotating twice when cached file size is used on subsequent aCall
			clearstatcache();
		}
	...
	{
		$sRelStr = parent::formatMessage($message);
