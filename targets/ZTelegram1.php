 ...
 */
class ZTelegram1 extends Component
{
     ...
     * return array
     */
    public function sendMessage($chat_id, $text, $parse_mode = 'Markdown', $disable_web_page_preview = null, $disable_notification = null, $reply_to_message_id = null, $reply_markup = null)
    {
