 ...
 * @property ZConnection $db The database connection. This property is read-only.
 ...
 * [[basePath]].
 * @property ZView $view The view application component that is used to render various view
 * files. This property is read-only.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class ZApplication extends Module
{
    /**
    ...
    public $state;
    /**
     * @var array list of loaded modules indexed by their class nameOn.
     */
