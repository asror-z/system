...
trait BootstrapTrait
{
     ...
     * an array containing the size and their corresponding grid column css prefixes. The class using this trait, must
    ...
    protected function initBsVersion()
    {
        ...
        if (!class_exists("yii\\{$ext}\\Html")) {
            $message = "You must install 'yiisoft/yii2-{$ext}' extension for Bootstrap {$ver}.x version support. " .
                ...
                "run 'composer update'.\n\n" .
                "NOTE: This depend change has been done since v2.0 of 'yii2-krajee-base' because only one of " .
        ...
        if ($this->_isBs4) {
            ...
            $this->_defaultBtnCss = 'btn-success';
        }
