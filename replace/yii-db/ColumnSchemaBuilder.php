 ...
 *
 * See [[SchemaBuilderTrait]] for more detailed title and usage examples.
 *
...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    public $bHideDyna = false;
    public $bHideForm = false;
    ...
    public function inject()
    {
        ...
        $item->bHideDyna = $this->bHideDyna;
        $item->bHideForm = $this->bHideForm;

        $item->sWidget = $this->sWidget;
        $item->comments = $this->comments;

        $item->aEnum = $this->aEnum;
        $item->options = $this->options;

        $this->comment = ZJsonHelper::encode($this->comments);

        return $this;
    }
    

    public function hideDyna()
    {
        $this->bHideDyna = true;
        return $this;
    }
    ...
    protected function buildCompleteString($format)
    {
        $placeholderValues = [
            ...
            '{pos}' => $this->ifirst ? $this->buildFirstString() : $this->buildAfterString(),
